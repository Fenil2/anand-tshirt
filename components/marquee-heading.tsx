...
export function MarqueeHeading({ text }: MarqueeHeadingProps) {
  ...
  return (
    <div className="py-5 sm:py-8">
      <div className="reveal-scale mx-auto flex max-w-[1280px] flex-wrap items-center justify-center gap-x-4 gap-y-2 px-4 text-center uppercase leading-[1.12] sm:gap-x-6 lg:gap-x-8">
